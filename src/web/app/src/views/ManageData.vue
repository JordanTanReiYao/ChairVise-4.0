...
Vue.use(V2Table);
  ...
  computed: {
    ...
    deleteThem(){
        if (this.recordType=="AuthorRecord") {
          this.$store.dispatch('deleteAuthorRecordVersionList',this.version);
        }
        if (this.recordType=="ReviewRecord") {
          this.$store.dispatch('deleteReviewRecordVersionList',this.version);
        }
        if (this.recordType=="SubmissionRecord") {
          this.$store.dispatch('deleteSubmissionRecordVersionList',this.version);
        }
    },
    getThem(){
        if (this.recordType=="AuthorRecord")
